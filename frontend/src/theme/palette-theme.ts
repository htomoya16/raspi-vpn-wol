...
export function applyPaletteTheme(root: HTMLElement, appearanceMode: EffectiveAppearanceMode, selectedTheme: ThemeOption): void {
  ...
  if (appearanceMode === 'dark') {
    ...
    root.style.setProperty('--btn-soft-bg', toRgba(darkSurfaceAlt, 0.5))
    root.style.setProperty('--btn-soft-text', mixHex('#d6e5ff', selectedTheme.accent, 0.28))
    root.style.setProperty('--btn-soft-border', toRgba(mixHex(darkLine, selectedTheme.accent, 0.18), 0.76))
    ...
    root.style.setProperty('--badge-device-bg', toRgba(mixHex('#4c9dff', selectedTheme.primary, 0.32), 0.22))
    root.style.setProperty('--badge-device-text', mixHex('#e9f0ff', selectedTheme.accent, 0.08))
    root.style.setProperty('--badge-device-border', toRgba(mixHex('#68adff', selectedTheme.accent, 0.24), 0.72))
    root.style.setProperty('--loading-spinner-track', toRgba(mixHex('#a3bef0', selectedTheme.accent, 0.18), 0.35))
    root.style.setProperty('--feedback-success-bg', toRgba(mixHex('#38a46e', selectedTheme.accent, 0.16), 0.22))
    root.style.setProperty('--feedback-success-text', mixHex('#d9f8e8', selectedTheme.accent, 0.08))
    root.style.setProperty('--feedback-success-border', toRgba(mixHex('#38a46e', selectedTheme.primary, 0.18), 0.36))
    root.style.setProperty('--panel-border', toRgba(darkLine, 0.34))
    root.style.setProperty('--panel-shadow', '0 20px 45px rgba(2, 8, 24, 0.45)')
    root.style.setProperty('--overlay-panel-shadow', toRgba(mixHex('#020818', selectedTheme.primaryStrong, 0.56), 0.55))
    root.style.setProperty('--modal-bg', toRgba(mixHex(darkSurfaceStrong, darkBase, 0.28), 0.94))
    root.style.setProperty('--modal-border', toRgba(mixHex(darkLine, selectedTheme.primary, 0.24), 0.82))
    root.style.setProperty('--modal-text-sub', mixHex('#b7caec', selectedTheme.accent, 0.22))
    root.style.setProperty('--theme-swatch-border', toRgba(mixHex('#dceaff', selectedTheme.accent, 0.12), 0.35))
    ...
    root.style.setProperty('--timeline-axis-hourly', mixHex('#9bb3dd', selectedTheme.accent, 0.22))
    ...
    root.style.setProperty('--mobile-nav-text', mixHex('#b5c8eb', selectedTheme.accent, 0.24))
    root.style.setProperty('--mobile-nav-text-active', mixHex('#ffffff', selectedTheme.accent, 0.08))
  ...
  root.style.setProperty('--btn-soft-bg', toRgba(lightSurfaceAlt, 0.66))
  root.style.setProperty('--btn-soft-text', mixHex('#274471', selectedTheme.primaryStrong, 0.32))
  root.style.setProperty('--btn-soft-border', toRgba(mixHex(lightLine, selectedTheme.primaryStrong, 0.2), 0.84))
  ...
  root.style.setProperty('--badge-device-bg', toRgba(mixHex('#4c9dff', selectedTheme.primary, 0.3), 0.16))
  root.style.setProperty('--badge-device-text', mixHex('#1f3d6a', selectedTheme.primaryStrong, 0.24))
  root.style.setProperty('--badge-device-border', toRgba(mixHex('#68adff', selectedTheme.primary, 0.3), 0.56))
  root.style.setProperty('--loading-spinner-track', toRgba(mixHex('#8ca9d8', selectedTheme.primary, 0.24), 0.32))
  root.style.setProperty('--feedback-success-bg', toRgba(mixHex('#208856', selectedTheme.primary, 0.24), 0.18))
  root.style.setProperty('--feedback-success-text', mixHex('#1c8152', selectedTheme.primaryStrong, 0.16))
  root.style.setProperty('--feedback-success-border', toRgba(mixHex('#208856', selectedTheme.primaryStrong, 0.22), 0.34))
  ...
  root.style.setProperty('--overlay-panel-shadow', toRgba(mixHex('#2f568f', selectedTheme.primaryStrong, 0.36), 0.2))
  root.style.setProperty('--modal-bg', toRgba(lightSurfaceStrong, 0.98))
  root.style.setProperty('--modal-border', toRgba(mixHex(lightLine, selectedTheme.primary, 0.24), 0.86))
  root.style.setProperty('--modal-text-sub', mixHex('#5f78a8', selectedTheme.primaryStrong, 0.28))
  root.style.setProperty('--theme-swatch-border', toRgba(mixHex('#8bb2e5', selectedTheme.primary, 0.24), 0.42))
  ...
  root.style.setProperty('--timeline-axis-hourly', mixHex('#5f78a8', selectedTheme.primaryStrong, 0.18))
  ...
  root.style.setProperty('--floating-switch-icon-filter', 'brightness(0) saturate(100%) invert(12%) sepia(27%) saturate(603%) hue-rotate(183deg) brightness(92%) contrast(88%)')
